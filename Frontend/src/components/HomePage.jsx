...
/>
          ...
          <p className="text-lg md:text-2xl text-gray-300 max-w-3xl mx-auto font-light leading-relaxed">
            ...
            <span className="text-blue-300 font-medium">NASA Research</span>{" "}
            into{" "}
            <span className="text-cyan-300 font-medium">AI-powered actionable insights</span>{" "}
      ...
      <section id="how-it-works" className="relative py-20 px-6" style={{ zIndex: 10 }}>
              ...
              return (
                ...
                >
                  <div className={isEven ? "md:col-start-1" : "md:col-start-2"}>
                    <div className={`${theme.cardBg} rounded-xl hover:border-blue-400 hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-300 p-8 space-y-6`}>
      ...
      {/* About Team Section */}
      <section id="about-team" className="relative py-20 px-6" style={{ zIndex: 10 }}>
        <div className="max-w-7xl mx-auto space-y-16">
          <motion.div
            initial="hidden"
            whileInView="visible"
          ...
          <motion.div
            ...
            variants={fadeInUpVariant}
          >
            <div className={`${theme.cardBg} rounded-xl shadow-2xl shadow-blue-500/10 p-8`}>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                {projectStats.map((stat, index) => {
                  ...
                  return (
                    ...
                    >
                      <div className="w-16 h-16 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full flex items-center justify-center mx-auto mb-3 shadow-lg shadow-blue-500/30">
                        <Icon className="w-8 h-8 text-white" />
                      </div>
            ...
            {teamMembers.map((member, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="h-full"
                >
                  <div className={`${theme.cardBg} rounded-xl h-full flex flex-col hover:border-cyan-400 hover:shadow-xl hover:shadow-cyan-500/10 transition-all duration-300 p-6`}>
